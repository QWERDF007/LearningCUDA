...
for H, W in Sizes:
    ...
    run_benchmark(lib.sigmoid_f32, a, "f32", out)
    run_benchmark(lib.sigmoid_f32x4, a, "f32x4", out)
    run_benchmark(torch.sigmoid, a, "f32_torch", None)
    ...
    run_benchmark(lib.sigmoid_f16, a, "f16", out)
    run_benchmark(lib.sigmoid_f16x2, a, "f16x2", out)
    run_benchmark(lib.sigmoid_f16x8_pack, a, "f16x8_pack", out)
